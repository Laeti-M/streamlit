...
if options == 'Contexte et objectifs du projet' :
    ...
    st.write("Le rapport sur le bonheur dans le monde (**World Happiness Report**, https://worldhappiness.report/) est une enquête de référence sur l'état du bonheur dans le monde. Le rapport continue de gagner en reconnaissance mondiale, les gouvernements, les organisations et la société civile utilisant de plus en plus les indicateurs de bonheur pour éclairer leurs décisions politiques.")
